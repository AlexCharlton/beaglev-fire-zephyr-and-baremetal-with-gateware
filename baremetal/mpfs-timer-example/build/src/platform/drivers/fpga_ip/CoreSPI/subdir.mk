...
C_SRCS += \
../src/platform/drivers/fpga_ip/CoreSPI/core_spi.c 

OBJS += \
./src/platform/drivers/fpga_ip/CoreSPI/core_spi.o 

C_DEPS += \
./src/platform/drivers/fpga_ip/CoreSPI/core_spi.d 


# Each subdirectory must supply rules for building sources it contributes
src/platform/drivers/fpga_ip/CoreSPI/%.o: ../src/platform/drivers/fpga_ip/CoreSPI/%.c src/platform/drivers/fpga_ip/CoreSPI/subdir.mk
	@echo 'Building file: $<'
